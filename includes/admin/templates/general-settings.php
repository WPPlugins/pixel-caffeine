						...
						<div class="panel-body">
							<?php if ( $page->get_addons_detected() ) : ?>
								...
								<div class="form-group ecomm-conversions">
									<div class="control-label">
										<h3 class="tit"><?php _e( 'Track this eCommerce Conversions', 'pixel-caffeine' ) ?><a href="#_" class="btn btn-fab btn-fab-mini btn-help"></a></h3>
									</div>
									...
									<div class="control-wrap">
										...
										<div class="checkbox">
											<label>
												<input
													type="checkbox"
													name="<?php $page->field_name( 'aepc_enable_search' ) ?>"
													id="<?php $page->field_id( 'aepc_enable_search' ) ?>"
													<?php checked( $page->get_value( 'aepc_enable_search' ), 'yes' ) ?>>
												<?php _e( 'Search', 'pixel-caffeine' ) ?>
											</label>
										</div>
