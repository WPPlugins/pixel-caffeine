...
class AEPC_Pixel_Scripts {
	...
	public static function init() {
		...
		add_action( 'wp_footer', array( __CLASS__, 'track_standard_events' ) );
		add_action( 'wp_footer', array( __CLASS__, 'track_advanced_events' ) );
		add_action( 'wp_footer', array( __CLASS__, 'track_custom_fields' ) );
	...
	public static function enqueue_scripts() {
		...
		wp_register_script( 'aepc-pixel-events', PixelCaffeine()->plugin_url() . "/assets/js/pixel-events{$suffix}.js", array( 'jquery' ), PixelCaffeine()->version, true );
